                    ...
                    <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        <h6 class="dropdown-header d-flex align-items-center">
                            ...
                            <div class="dropdown-user-details">
                                <div class="dropdown-user-details-name">Lecturer</div>
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    ...
                    <div class="sidenav-footer">
                        <div class="sidenav-footer-content">
                            ...
                            <div class="sidenav-footer-title">Lecturer</div>
                        </div>
                    </div>
                </nav>
            </div>
                            ...
                            <div class="page-header-content pt-4">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        ...
                                        <div class="page-header-subtitle">This is <b>Lecturer</b> dashboard.</div>
                                    </div>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-8 col-xxl-12">
                                                <div class="text-center px-4 mb-4 mb-xl-0 mb-xxl-4">
                                                    <h1 class="text-secondary">Welcome Back!</h1>
                                                    <p class="text-gray-700 mb-0">It&apos;s time to get started! View new opportunities now, or continue on your previous work.</p>
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-xxl-12 text-center"><img class="img-fluid" src="assets\admin\assets\img\freepik\processing-pana.svg" style="max-width: 14rem;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
