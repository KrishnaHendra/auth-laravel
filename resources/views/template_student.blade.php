                    ...
                    <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        <h6 class="dropdown-header d-flex align-items-center">
                            ...
                            <div class="dropdown-user-details">
                                <div class="dropdown-user-details-name">Student</div>
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    ...
                    <div class="sidenav-footer">
                        <div class="sidenav-footer-content">
                            ...
                            <div class="sidenav-footer-title">Student</div>
                        </div>
                    </div>
                </nav>
            </div>
                            ...
                            <div class="page-header-content pt-4">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        ...
                                        <div class="page-header-subtitle">This is <b>Student</b> dashboard.</div>
                                    </div>
                                ...
                                <div class="card h-100">
                                    <div class="card-body h-100 d-flex flex-column justify-content-center py-5 py-xl-4">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-xl-4 col-xxl-12 text-center"><img class="img-fluid" src="assets\admin\assets\img\freepik\team-spirit-pana.svg" style="max-width: 14rem;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
